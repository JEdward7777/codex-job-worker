...
class GradioDemo:
    ...
    def load_verses(self) -> List[Dict]:
        ...
        logger.info(f"Loaded {len(verses)} generated verses.")
        return verses
    ...
    def launch(self):
        ...
        with gr.Blocks(title="Xiang TTS Demo") as demo:
            gr.Markdown("# Xiang TTS Generation Demo")
            ...
            with gr.Tab("Custom Generation"):
                custom_text = gr.Textbox(
                    label="Enter Text (Xiang/Chinese)",
